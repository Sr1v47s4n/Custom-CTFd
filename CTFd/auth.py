...
def reset_password(data=None):
    if config.can_send_mail() is False:
        return render_template(
            ...
            errors=[
                markup(
                    "Oops! Looks like we forgot to add the email feature! 😅<br>"
                    "Don't worry! Just reach out to one of our organizers, and we'll get that password reset for you in no time! 🚀"
                )
            ],
        )
