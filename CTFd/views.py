...
"""
            ...
            set_config(
                ...
                "Heads Up! Something's Changed at Null EEC CTF!",
            )
            set_config(
                "password_change_alert_body",
                (
                    "Looks like something has been switched up out there!.\n\n"
                    "Oops! Your password was recently changed on the Null EEC CTF portal. If that wasn’t you, no worries at all! Just click this link to retrieve your password and get back in the game: Get Your Password Back -> {url}"
                ),
            )
